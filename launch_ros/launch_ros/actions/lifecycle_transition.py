...
class LifecycleTransition(Action):
    ...
    def parse(cls, entity: Entity, parser: Parser):
        ...
        kwargs['lifecycle_node_names'] = entity.get_attr('lifecycle_node_names', data_type=List[str])
        # Probably need to make this parsable through a dict for convenience
        kwargs['transitions_ids'] = entity.get_attr('transitions_ids', data_type=List[int])
        return cls, kwargs
